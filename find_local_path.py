...
class turtle_listener():
   ...
   def odom_callback(self,msg): ## turtle Status Subscriber
       self.is_odom = True
       self.is_status=True
       self.status_msg = msg.pose.pose.position
       self.status_msg.x = msg.pose.pose.position.x
       self.status_msg.y = msg.pose.pose.position.y
       ...
       br.sendTransform((self.status_msg.x, self.status_msg.y, 1),
...
if __name__ == '__main__' :
   try:
       ...
       global_path = p_r.read_txt("mission1_path.txt")
